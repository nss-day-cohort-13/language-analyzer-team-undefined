behaviorDict = {
    ...
    ('spiritual', 'emotional', 'self-knowledge', 'personal', 'love', 'belief', 'soul',
        ...
        'passion', 'divine', 'holy', 'sacred', 'intangible', 'ethereal', 'ghost', 'pure', 'rarefied', 'faith', 'praise', 'pray', 'Russell', 'god', 'angel', 'preacher', 'rabbi', 'cleric', 'priest', 'lama', 'friar', 'pontiff'): 'spiritual',
