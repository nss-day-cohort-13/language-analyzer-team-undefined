behaviorDict = {
  ...
  # Mentoring
  ('inspiring', 'respect', 'share', 'development', 'ability', 'opinion', 'role', 'teaching'):'mentoring',

  # Inquisitive
  ('interesting', 'psychological', 'sensible', 'truth', 'exploration', 'opinion', 'evidence', 'intelligence', 'wonder', 'fact', 'mind', 'conclusion', 'study', 'interest', 'mind', 'meaning', 'assumption', 'idea', 'experiment', 'debate', 'thought'):'inquisitive',

  # Transaction
  ('generous', 'lucky', 'worth', 'honored', 'filled', 'rewarded', 'satisfied', 'attainment', 'promise', 'opportunity', 'goal', 'offer', 'credit', 'money', 'gain', 'proceeding', 'share', 'job', 'service', 'experiment', 'task', 'relation', 'retrieve', 'validate', 'livelihood'):'transaction',

  # Encouragement
  ('funny', 'sweet', 'good', 'positive', 'great', 'happy', 'eager', 'greatest', 'satisfied', 'respect', 'love', 'enthusiasm', 'positivity', 'confidence', 'felicity', 'validate'):'encouragement',
